...
This project is based on the GRANDstack Starter. To begin using it clone this repo and follow the instructions below and create the neo4j instance using Docker. 
The UI component of the app is deprecated and does not work. It can be ignored.

You should be able to begin the process using 
```
...
Afterwards you can also access the instance through neo4j Desktop.  
